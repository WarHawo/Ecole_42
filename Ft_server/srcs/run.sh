...
echo "\033[1;32mFT_SERVEUR HWAR\033[0;m"

#CHMOD START.SH
chmod 775 /run.sh

#SSL KEY AND CERTIFICATE
openssl req -newkey rsa:4096 -days 365 -nodes -x509 -subj "/C=FR/ST=75/L=Paris/O=42Paris/OU=hwar/CN=localhost" -keyout localhost.dev.key -out localhost.dev.crt
